/**
 * #161a -- ported from web/src/lib/refusal.ts UNCHANGED but for the two
 * import lines (the desktop keeps BEARING_KEYS in lib/bearings.ts). Keep the
 * two in step; the web file is the one that carries the history below.
 *
...
import { BEARING_KEYS } from "./bearings";
