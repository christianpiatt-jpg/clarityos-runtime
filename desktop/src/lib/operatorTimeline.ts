...
//
// Desktop mirror of web/src/lib/operatorTimeline.ts. Pure
// deterministic, client-side string builder producing a human-
// readable temporal cross-section of the Card 36 system overlay.
