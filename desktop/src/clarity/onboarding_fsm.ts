// desktop/src/clarity/onboarding_fsm.ts
//
// Desktop copy of the canonical onboarding FSM (Onboarding Spec §1.1,
...
// in-memory only; cross-launch resume should be wired through Electron
// safeStorage (already used by Q4 vault-secret persistence) separately.
