/**
 * #142 / #161 -- dollars on the surface (the web's lib/money.ts, verbatim).
 * The ledger is MICRO-DOLLARS; the member sees dollars at $0.01. CT-1 RULED
 * 09-03/09-04: display floors to the cent (sub-cent -> "$0.00"); the
 * deduction math stays in micro and is never touched here. The backend's
 * usage_billing.micro_to_dollars is the twin.
 */
